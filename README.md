...
Author: SOUHINI ROY
A simple Python console project for storing and managing student records.
Covers: lists, dictionaries, functions, loops, conditions, file handling,
sorting, searching, exception handling, and modular programming.
"""
